...
from locations.models import City, State, FSCity, SSCity, TSCity
from .texts import *


def generate():
    cities_descr = parse_wiki('cities.txt')
    cities_names = get_data_names('cities.txt')
